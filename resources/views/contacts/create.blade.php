...
<div class="col-md-12">
    <form action="{{route('contacts.store',array('user' =>  Auth::user()))}}" method="post"
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      <input type="text" class="form-control  {{ $errors->has('name') ? ' is-invalid' : '' }}"
                             name="name" id="name" placeholder="Contact Name" value="{{ old('name') }}">
                      @if ($errors->has('name'))
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control  {{ $errors->has('surnames') ? ' is-invalid' : '' }}"
                           name="surnames" id="surnames" placeholder="Contact Surnames" value="{{ old('surnames') }}">
            ...
            <div class="col">
                ...
                <div class="form-group ">
                    ...
                    <input type="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}"
                           name="email" id="email" placeholder="Contact  Email" value="{{ old('email') }}">
            ...
            <div class="col">
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control {{ $errors->has('address') ? ' is-invalid' : '' }}"
                           name="address" id="address" placeholder="Contact Address" value="{{ old('address') }}">
            ...
            <div class="col">
                <div class="form-group ">
                    ...
                    <input type="number" class="form-control {{ $errors->has('movil') ? ' is-invalid' : '' }}"
                           name="movil" id="movil" min="0" placeholder="Contact Movil" value="{{ old('movil') }}">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <textarea name="notes" id="notes" cols="5" rows="5" class="form-control"
                          placeholder="enter Contact notes..">{{ old('notes') }}</textarea>
            </div>
        </div>
